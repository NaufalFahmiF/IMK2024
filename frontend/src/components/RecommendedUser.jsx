	...
	const renderButton = () => {
		...
		switch (connectionStatus?.data?.status) {
			case "pending":
				return (
					<button
						className='px-3 py-1 rounded-full text-sm bg-yellow-500 text-white font-medium flex items-center'
						disabled
					>
			...
			default:
				return (
					<button
						className='px-3 py-1 rounded-full font-medium text-sm border border-primary text-primary hover:bg-primary transition-base hover:text-white transition-colors duration-200 flex items-center'
